...
export const SideBar = () => {
  return (
    <div className="sidebar py-9 px-5 ps-5 xl:ps-9 min-h-full flex flex-col border-r border-gray-500">
      <a
        href="/"
        className="flex items-center space-x-3 rtl:space-x-reverse mb-12">
      ...
      <div className="flex items-center gap-10 mb-6">
        <Avatar
          ...
          icon={<UserOutlined />}
        />
        <p className="text-white me-5">Hello hihi</p>
        <button
          className="inline-flex items-center justify-center w-[30px] h-[30px] rounded border border-orange-400"
          type="button">
      ...
      <div className=" text-white">
        <ul className="xl:text-[16px] text-[12px]">
          <li className="mb-5 uppercase text-white hover:text-orange-400">
            <NavLink to="admin" className="py-2 px-1">
              <i className="fa-solid fa-file me-2 w-[20px] text-center"></i>{" "}
              <span>Danh sách phim</span>
            </NavLink>
          </li>
          <li className="mb-5 ppercase text-white hover:text-orange-400">
            <NavLink to="danhsachnguoidung" className="py-2 px-1">
              <i className="fa-solid fa-user me-2 w-[20px] text-center"></i>{" "}
              <span>Danh sách người dùng</span>
            </NavLink>
          </li>
          <li className="mb-5 uppercase text-white hover:text-orange-400">
            <NavLink to="/" className="py-2 px-1">
              <i className="fa-solid fa-backward-step text-[15px] me-2 w-[20px] text-center"></i>{" "}
              <span>Về trang chủ</span>
            </NavLink>
          </li>
        </ul>
      </div>
      <span className="text-white md:text-[14px] text-[12px] mt-auto ">
