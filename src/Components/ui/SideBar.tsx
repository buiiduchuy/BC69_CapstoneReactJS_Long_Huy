    ...
    <div className="sidebar py-9 px-5 xl:ps-9 min-h-full flex flex-col border-r border-gray-500">
      ...
      >
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 w-8 h-8 justify-center text-sm text-orange-400 rounded-md xl:hidden hover:bg-gray-100"
      ...
      <div className={cn("flex items-center gap-10 mb-6")}>
        <Avatar
          style={{ backgroundColor: "#87d068" }}
          icon={<UserOutlined />}
        />
        <p className={cn("text-white me-5 xl:inline-block")}>Hello hihi</p>
        <button
          className={cn(
        ...
        <ul className="xl:text-[16px] text-[12px]">
          <li className={cn("mb-5 uppercase text-white hover:text-orange-400")}>
            <NavLink to="admin" className="py-2 px-1">
              <i
                className={cn("fa-solid fa-file me-2 w-[20px] text-center")}
              ></i>{" "}
              <span className={cn("xl:inline-block ms-3")}>Danh sách phim</span>
            </NavLink>
          </li>
          <li className={cn("mb-5 uppercase text-white hover:text-orange-400")}>
            <NavLink to="danhsachnguoidung" className="py-2 px-1">
              <i
                className={cn("fa-solid fa-user me-2 w-[20px] text-center")}
              ></i>{" "}
              <span className={cn("xl:inline-block ms-3")}>
          ...
          <li className={cn("mb-5 uppercase text-white hover:text-orange-400")}>
            <NavLink to="/" className="py-2 px-1">
              ...
              ></i>{" "}
              <span className={cn("xl:inline-block ms-3")}>Về trang chủ</span>
            </NavLink>
          </li>
        </ul>
      </div>
      <span className={cn("text-white md:text-[14px] text-[12px] mt-auto")}>
