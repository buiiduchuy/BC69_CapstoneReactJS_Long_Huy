...
export const SideBar = (props: Props) => {
  ...
  return (
    <div className="sidebar py-9 px-5 xl:ps-9 min-h-full flex flex-col border-r border-gray-500">
      ...
      <div
        className={cn("flex items-center gap-10 mb-6", {
          "xl:justify-normal justify-center": !activeSidebar,
        })}>
        <Avatar
      ...
      <div className=" text-white">
        <ul className="xl:text-[16px] text-[12px]">
          <li
            className={cn("mb-5 uppercase text-white hover:text-orange-400", {
              "xl:text-left text-center": !activeSidebar,
            })}>
            <NavLink to="admin" className="py-2 px-1">
              <i
                className={cn("fa-solid fa-file me-2 w-[20px] text-center", {
                  "text-[20px] me-0": !activeSidebar,
                })}></i>{" "}
              <span
